...
const TaskDialogueBox = ({ task }) => {
    ...
    const items = [
        {
            label: "Open Task",
            icon: <Folder className="mr-2 h-5 w-5" aria-hidden="true" />,
        ...
        {
            label: "Add Sub-Task",
            icon: <Plus className="mr-2 h-5 w-5" aria-hidden="true" />,
            onClick: () => setOpen(true),
        },
        {
            label: "Duplicate",
            icon: <Copy className="mr-2 h-5 w-5" aria-hidden="true" />,
...
export default TaskDialogueBox;
