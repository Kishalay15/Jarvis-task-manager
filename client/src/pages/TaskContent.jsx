...
const TABS = [
    { title: "Task Detail", icon: <List /> },
    { title: "Activities/Timeline", icon: <Activity /> },
];
                ...
                <div className='w-full flex flex-wrap gap-5'>
                    ...
                    {isLoading ? (
                        ...
                        <button
                            ...
                            className="bg-blue-600 text-white rounded px-3 py-2 outline-none">
                            <span>Submit</span>
                        </button>
                    )}
                </div>
